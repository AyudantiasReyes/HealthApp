...
public class LabelCleaner {
    ...
    private static final String FILTRO_CARBS = "[C|c]arbohidratos;([T|t]otales;)?[0-9]+g?" ;
    private static final String FILTRO_AZUCAR = "[A|a][z][a-z|ú]*;[0-9]+g?|Az[u|ú]care[s]?;[0-9]+g?" ;
